<?php
	...
	class controller{
		...
		function update(){
			...
			$update = $this->model->updateMhs($nim, $nama, $angkatan, $fakultas, $prodi, $genre, $tempatwisata);
		...
		function insert(){
			...
			$insert = $this->model->insertMhs($nim, $nama, $angkatan, $fakultas, $prodi, $genre, $tempatwisata);
			header("location:index.php");
		}
